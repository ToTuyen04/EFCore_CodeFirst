...
namespace EFCore_CodeFirst.Db.Migrations
{
    ...
    [Migration("20250901153301_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlayerPlayerInstrument", b =>
                {
                    b.Property<int>("InstrumentsPlayerInstrumentId")
                        .HasColumnType("int");

                    b.Property<int>("PlayerId")
                        .HasColumnType("int");

                    b.HasKey("InstrumentsPlayerInstrumentId", "PlayerId");

                    b.HasIndex("PlayerId");

                    b.ToTable("PlayerPlayerInstrument");
                });

            modelBuilder.Entity("PlayerPlayerInstrument", b =>
                {
                    b.HasOne("EFCore_CodeFirst.Db.Models.PlayerInstrument", null)
                        .WithMany()
                        .HasForeignKey("InstrumentsPlayerInstrumentId")
